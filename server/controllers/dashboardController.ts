  ...
  getTotalMem: async (req, res, next) => {
    try {
      ...
      return next({
        ...
        status: 500,
        message: {
          err: 'Error occured while retrieving dashboard memory data',
        },
      });
    }
  },
  ...
  getTotalCpu: async (req, res, next) => {
    try {
      ...
      return next({
        ...
        status: 500,
        message: {
          err: 'Error occured while retrieving dashboard cpu data',
        },
      });
    }
  },
  ...
  getTotalTransmit: async (req, res, next) => {
    try {
      ...
      return next({
        ...
        status: 500,
        message: {
          err: 'Error occured while retrieving dashboard bytes transmit data',
        },
      });
    }
  },
  ...
  getTotalReceive: async (req, res, next) => {
    try {
      ...
      return next({
        ...
        status: 500,
        message: {
          err: 'Error occured while retrieving dashboard bytes receive data',
        },
      });
    }
  },
