  ...
  return (
    <div id="db-container">
      ...
      <div id="metric-graphs">
        ...
        <LineGraph
          label="Memory Usage"
          query="/api/dashboard/mem"
          backgroundColor={colors.translucent.cyan}
          borderColor={colors.solid.cyan}
          yAxisType="gigabytes"
        />
        <LineGraph
          label="Node Bytes Transmitted"
          query="/api/dashboard/transmit"
          backgroundColor={colors.translucent.orange}
          borderColor={colors.solid.orange}
          yAxisType="kilobytes"
        />
        <LineGraph
          label="Node Bytes Received"
          query="/api/dashboard/receive"
          backgroundColor={colors.translucent.pink}
          borderColor={colors.solid.pink}
          yAxisType="kilobytes"
        />
        {customGraphs}
      </div>
